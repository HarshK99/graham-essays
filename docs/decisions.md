...
- The GitHub fork exists at https://github.com/HarshK99/graham-essays. Local history starts from upstream revision `96885e3b4018f0f1d976634e26b27a86e94aacfc`; project adaptations are prepared for the user-authorised GitHub push on `ipad-reading-edition`.
